/* =========================================
   GLOBAL VARIABLES (Typing Effect)
========================================= */
const texts = [
...
function initializeProjectSlider() {
  ...
  if (slider && slideLeft && slideRight) {
    ...
    slideRight.addEventListener('click', () => {
      let isAtEnd = slider.scrollLeft >= (slider.scrollWidth - slider.clientWidth - 5);
      if (isAtEnd) {
    ...
    slideLeft.addEventListener('click', () => {
      ...
      if (isAtStart) {
        slider.scrollTo({ left: slider.scrollWidth, behavior: 'smooth' }); // Loop forward
      } else {
        slider.scrollBy({ left: -(slider.clientWidth / 1.5), behavior: 'smooth' }); 
      }
    });
    ...
    slider.addEventListener('scroll', () => {
      let scrollIndex = Math.round(slider.scrollLeft / slider.clientWidth);
